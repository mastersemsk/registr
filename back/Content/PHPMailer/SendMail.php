...
class SendMail
{
    ...
    try {
     ...
     $mail->Username   = 'help@wm-semsk.kz';                     //SMTP username
     $mail->Password   = 'hmxvtsrlpirnondk';                     //SMTP password
     $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
     $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

     //Recipients 
     $mail->setFrom('help@wm-semsk.kz', 'WMsemsk');         // Адрес самой почты и имя отправителя
     $mail->addAddress($pochta, $imia);                     // Получатель письма
     //$mail->addAddress('ellen@example.com');               //Name is optional
     $mail->addReplyTo('help@wm-semsk.kz', 'Information');
